...
class PageHandler implements PageHandlerInterface
{
    ...
    public function __construct(ManagerRegistry $managerRegistry, $entityClass, FormFactoryInterface $formFactory)
    {
        $this->entityClass = $entityClass;
        $this->om = $managerRegistry->getManagerForClass($this->entityClass);
